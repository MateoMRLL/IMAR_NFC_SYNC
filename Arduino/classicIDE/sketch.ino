//Save from the former project (you can use this code on Arduino IDE after installing all the librairies)
  ...
  // Backend server endpoints (make sure to change IP Address)
  const char* scanCardUrl = "http://ip_address:5000/api/nfc/scan"; 
  const char* nfcLoginUrl = "http://ip_address:5000/nfc_login"; 
